...
/**
 * A sticky tranform that keeps in internal hash of all returned objects to
 * ensure that identity is maintained. This has the potential to blow up in
 * terms of memory usage if a lot of objects are being streamed.
